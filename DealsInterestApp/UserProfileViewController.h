...
@property (weak, nonatomic) IBOutlet UIButton *profileSlideBtn;
@property (weak, nonatomic) IBOutlet UILabel *dealedLabel;
@property (weak, nonatomic) IBOutlet UIView *dealedView;

@property (strong, nonatomic) IBOutlet UIView *profileSlideOut;
@property(weak,nonatomic) NSString *postUserId;
